...
lab.inputs = { "rabbasca-warp-anomaly", "rabbasca-warp-trace", "rabbasca-twisted-knowledge", "rabbasca-uncanny-knowledge" }
...
lab.flags = { "placeable-player", "player-creation", "get-by-unit-number" }
