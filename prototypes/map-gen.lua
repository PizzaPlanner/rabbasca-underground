data:extend {
  {
    ...
    expression = "93 - distance + 12 * basis_noise{x = x, y = y, seed0 = map_seed, seed1 = 'warpten', input_scale = 1/3 }"
  },
  {
    type = "noise-expression",
  ...
  {
    type = "noise-expression",
    name = "rabbasca_underground_resource_richness",
    expression = "100 * (1 + rabbasca_underground_resource_spots)"
  },
  {
    type = "noise-expression",
