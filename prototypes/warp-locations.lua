Rabbasca.Stabilizer.add_location{
    ...
    anomaly_replace_entities = { 
        { type = "poi", name = "rabbasca-warp-cell-empty", probability = 0.0008, floor = "stone-path" }, 
...
Rabbasca.Stabilizer.add_location{
    ...
    anomaly_replace_entities = { 
        { type = "poi", name = "rabbasca-warp-cell-empty", probability = 0.001, floor = "stone-path" }, 
...
Rabbasca.Stabilizer.add_location{
    ...
    anomaly_replace_entities = { 
        { type = "poi", name = "rabbasca-warp-cell-empty", probability = 0.0015, floor = "stone-path" }, 
...
Rabbasca.Stabilizer.add_location{
    ...
    anomaly_replace_entities = { 
        { type = "resource", name = "rabbasca-lithium-amide", probability = 0.008, richness = 200, floor = "ice-smooth" }, 
        { type = "poi", name = "rabbasca-warp-cell-empty", probability = 0.001, floor = "stone-path" }, 
    },
