...
Rabbasca.Stabilizer.add_location{
    ...
    anomaly_replace_entities = { { type = "resource", name = "rabbasca-yumako-mashup", probability = 0.0015, richness = 582, floor = "lowland-brown-blubber" }, },
    min_stay = 50,
    max_stay = 70,
}
Rabbasca.Stabilizer.add_location{
...
Rabbasca.Stabilizer.add_location{
    ...
    anomaly_replace_entities = { { type = "resource", name = "rabbasca-lithium-amide", probability = 0.008, richness = 200, floor = "ice-smooth" }, },
